                ...
                <div className="max-w-7xl px-5 mx-auto py-5 flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2 relative">
                        ...
                        <Link href="https://discord.com/api/oauth2/authorize?client_id=1014341550462996561&permissions=8&scope=bot%20applications.commands">
                            <a className="w-auto flex items-center justify-center shadow-lg gap-x-2 shadow-amber-600/20 rounded-xl py-2.5 font-medium px-7 bg-gradient-to-tl from-amber-500 to-amber-700 text-white  hover:opacity-80 transition duration-200 target="_blank">
                               Invite
                            </a>
               </Link>
                    </div>
