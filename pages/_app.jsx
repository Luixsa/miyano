...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/J69KSqvGeq" target="_blank",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/api/oauth2/authorize?client_id=1015702634423910512&permissions=0&scope=bot" target="_blank",
    },
       {
      link: true,
      name: "Vote",
