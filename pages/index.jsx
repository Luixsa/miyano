...
export default function Index() {
      ...
      <img width="500" src="https://cdn.discordapp.com/attachments/997188225040928799/1015283774541529249/kindpng_125085.png" />
       ...
       How about moderating your own server with Miyano bot? Create your own free world and create your own playlist, experience this pleasure with the best sounds. 
        ...
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
            ...
            <Link href={"https://discord.com/api/oauth2/authorize?client_id=1015702634423910512&permissions=0&scope=bot"} target="_blank">
              <a
                className={
  ...
  <Link href={"https://discord.gg/RDNNXqdVab"} target="_blank">
...
Vote Miyano</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            ...
            <a href="https://discord.com/api/oauth2/authorize?client_id=1015702634423910512&permissions=0&scope=bot" target="_blank" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
      ...
      <div className="flex flex-row w-full h-auto lg:h-56 my-14 lg:my-40 bg-gradient-to-br lg:px-30 from-neutral-900/90 flex items-center justify-start to-neutral-900/50 rounded-lg p-1 shadow-md">
              <>
                <div className="lg:mx-4 lg:p-8 py-4 lg:py-16 flex items-center justify-center flex-col text-center w-full lg:w-auto lg:text-left lg:flex-none">
                  <img src="https://cdn.discordapp.com/attachments/997187785154908311/1015832002492108891/unknown.png"  width="256" className="lg:hidden rounded-xl mb-5 shadow-xl shadow-black" />
                ...
                <img src="https://cdn.discordapp.com/attachments/997187785154908311/1015832002492108891/unknown.png" className="hidden lg:block rounded-xl perspective-right shadow-xl shadow-black" />
              </>
