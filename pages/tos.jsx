...
<div className="py-3"></div>
<p>⊳ To use certain discord bot commands, you need to vote for the <a className="text-white" href="https://discord.gg/J69KSqvGeq">Miyano</a> bot at certain intervals.</p>
</div>
    </div>
  );
}
